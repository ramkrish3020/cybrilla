...
const helmet = require("helmet");// accept various http header and secure app 
const swaggerUi = require('swagger-ui-express');
const swaggerDocument = require('./docs/swagger.json');
const bodyParser = require("body-parser");
let routers = require("./cb_src/routes");

const app = express();
app.enable("trust proxy");
const { handler } = require('./cb_src/middleware/errorHandler');
// middle wares section
const { CustomLogger } = require("./cb_src/middleware/logger");
...
app.use((req, res, next) => {
	...
	next();
}); // is used for logging request details 
